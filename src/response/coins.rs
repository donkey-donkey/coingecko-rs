...
pub struct CoinsItem {
    ...
    pub market_cap_rank: Value,
    pub coingecko_rank: Option<Value>,
    pub coingecko_score: Option<Value>,
    pub developer_score: Option<Value>,
    pub community_score: Option<Value>,
    pub liquidity_score: Option<Value>,
    pub public_interest_score: Option<Value>,
